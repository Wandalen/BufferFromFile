...
BufferFromFIle works on Windows, OSX, Linux other Unix-like systems.
The module doesn't depend of NaN and deprecated versions of Nodejs.
As well as standard ArrayBuffer this module can produce any kind of TypedBuffer and also deprecated Nodejs Buffer.
